...
//        }
    ...
    public void updateRecordButton(TLRPC.Chat chat, TLRPC.UserFull userFull) {
        ...
        audioVideoButtonContainer.invalidate();
        // Owner ruling D9.7 item 21: under Cybergram the enabled microphone glyph uses the same
        // low-saturation pale blue as the smiley and paperclip, not the upstream white.
